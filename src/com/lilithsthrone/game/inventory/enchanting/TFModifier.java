...
public enum TFModifier {
	...
	TF_MOD_FETISH_AGE_YOUNGER(Fetish.FETISH_AGE_YOUNGER),
	TF_MOD_FETISH_AGE_OLDER(Fetish.FETISH_AGE_OLDER),
	TF_MOD_FETISH_PEE_GIVING(Fetish.FETISH_PEE_GIVING),
	TF_MOD_FETISH_PEE_RECEIVING(Fetish.FETISH_PEE_RECEIVING)
	;
